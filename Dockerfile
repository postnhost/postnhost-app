...
# This Dockerfile is designed for production, not development. Deploy it to Fly.io or run it by hand:
# docker build -t demo .
...
# Make sure NODE_VERSION matches the Node version in mise.toml
